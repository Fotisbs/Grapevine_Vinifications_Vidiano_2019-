...
INPUT_DIR=input
OUT_DIR=output
SAMSA=/home/penbio18/software/RNAseq/SAMSA2/samsa2

source "$SAMSA/bash_scripts/lib/common.sh"


# 1. PEAR
PEAR=$SAMSA/programs/pear-0.9.10-linux-x86_64/bin/pear

# 2. Trimmomatic
TRIMMOMATIC=$SAMSA/programs/Trimmomatic-0.36/trimmomatic-0.36.jar

# 3. SortMeRNA
SORTMERNA=$SAMSA/programs/sortmerna-2.1/sortmerna

# 4. DIAMOND
diamond_database="$SAMSA/refseq_db_bac_fung_arch_prot_plant_mito/Refseq_complete"
diamond_subsys_db="$SAMSA/full_databases/subsys_db"
DIAMOND="/home/penbio18/software/seq_search/diamond/diamond-2.0.11/diamond" # I tried a newer version for speed
#DIAMOND="$SAMSA/programs/diamond"

# 5. Aggregation
PY_DIR=$SAMSA/python_scripts
RefSeq_db="$SAMSA/refseq_db_bac_fung_arch_prot_plant_mito/Refseq_complete"
...
if [[ -n "$USE_TINY" ]]; then
  ...
  # Diamond databases
  diamond_database="/mnt/4abcb8af-e2eb-47e2-86d6-eed71f6d5304/dbs/samsa2/refseq_db_bac_fung_arch_prot_plant_mito/Refseq_complete"
  diamond_subsys_db="/mnt/4abcb8af-e2eb-47e2-86d6-eed71f6d5304/dbs/samsa2/full_databases/subsys_db"
  # Aggregation databases
  RefSeq_db="/mnt/4abcb8af-e2eb-47e2-86d6-eed71f6d5304/dbs/samsa2/refseq_db_bac_fung_arch_prot_plant_mito/Refseq_complete.fa"
  Subsys_db="/mnt/4abcb8af-e2eb-47e2-86d6-eed71f6d5304/dbs/samsa2/full_databases/subsys_db.fa"
fi
...
$SORTMERNA_DIR/rRNA_databases/silva-euk-28s-id98.fasta,$SORTMERNA_DIR/index/silva-euk-28s-db:\
$SORTMERNA_DIR/rRNA_databases/rfam-5s-database-id98.fasta,$SORTMERNA_DIR/index/rfam-5s-database-db:\
$SORTMERNA_DIR/rRNA_databases/rfam-5.8s-database-id98.fasta,$SORTMERNA_DIR/index/rfam-5.8s-database-db\
