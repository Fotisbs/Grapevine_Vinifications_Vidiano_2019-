...
mypermanova_MUST_Bacteria_Vidiano_2019_100 <- adonis2(
  MUST_Bacteria_Vidiano_2019_100@otu_table ~ vinification + stage2,
  data = data.frame(MUST_Bacteria_Vidiano_2019_100@sam_data),
  method = "bray",
  by = "margin"
)
